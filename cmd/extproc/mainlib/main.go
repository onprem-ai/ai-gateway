...
func Main(ctx context.Context, args []string, stderr io.Writer) (err error) {
	...
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/chat/completions"), extproc.NewFactory(
		chatCompletionMetricsFactory, tracing.ChatCompletionTracer(), endpointspec.ChatCompletionsEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/completions"), extproc.NewFactory(
		completionMetricsFactory, tracing.CompletionTracer(), endpointspec.CompletionsEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/embeddings"), extproc.NewFactory(
		embeddingsMetricsFactory, tracing.EmbeddingsTracer(), endpointspec.EmbeddingsEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/responses"), extproc.NewFactory(
		responsesMetricsFactory, tracing.ResponsesTracer(), endpointspec.ResponsesEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/audio/speech"), extproc.NewFactory(
		speechMetricsFactory, tracing.SpeechTracer(), endpointspec.SpeechEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.OpenAI, "/v1/images/generations"), extproc.NewFactory(
		imageGenerationMetricsFactory, tracing.ImageGenerationTracer(), endpointspec.ImageGenerationEndpointSpec{}, extproc.WithSchemaName("openai")))
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.Cohere, "/v2/rerank"), extproc.NewFactory(
		rerankMetricsFactory, tracing.RerankTracer(), endpointspec.RerankEndpointSpec{}, extproc.WithSchemaName("cohere")))
	...
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.Anthropic, "/v1/models")+"/", extproc.NewAnthropicModelRetrieveProcessor)
	server.Register(path.Join(flags.rootPrefix, endpointPrefixes.Anthropic, "/v1/messages"), extproc.NewFactory(
		messagesMetricsFactory, tracing.MessageTracer(), endpointspec.MessagesEndpointSpec{}, extproc.WithSchemaName("anthropic")))
